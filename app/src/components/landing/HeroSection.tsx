      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div ref={textRef} className="space-y-6">
            ...
            <div
              className={cn(
                "inline-flex items-center gap-2 rounded-full bg-genea-green/10 px-4 py-2 text-sm font-medium text-genea-green opacity-0",
                textVisible && "animate-fade-up"
              )}
              style={{ animationDelay: textVisible ? "0ms" : "0ms" }}
            >
            ...
            <button
              ...
              className={cn(
                "flex items-center gap-2 py-2 text-genea-green hover:underline font-medium transition-colors focus:outline-none focus-visible:underline opacity-0",
                textVisible && "animate-fade-up"
              )}
            ...
            <div
              className={cn(
                "inline-flex items-center gap-2 rounded-full bg-ih-surface-warm px-4 py-2 text-sm opacity-0",
                textVisible && "animate-fade-up"
              )}
          ...
          <div
            ...
            className={cn(
              "lg:pl-8 opacity-0",
              imageVisible && "animate-scale-in"
            )}
            style={{ animationDelay: imageVisible ? "200ms" : "0ms" }}
          >
            <BeforeAfterSlider
